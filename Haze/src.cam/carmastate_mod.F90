...
!    if (cstate%f_lat == -2.00 .and. cstate%f_lon == 100) then
!      write(*,*) "rhoa_wet", cstate%f_rhoa_wet
!      write(*,*) "rhoa", cstate%f_rhoa
!      write(*,*) "zmet", cstate%f_zmet
!      write(*,*) "zmet*dz",cstate%f_zmet*cstate%f_dz
!      write(*,*) "dz/zmet",dz/zmet
!      write(*,*) "vf",cstate%f_vf
!      write(*,*) "dkz",cstate%f_dkz 
!    endif

    !write(*,*) "zczmet",cstate%f_zc * cstate%f_zmet
...
!      if (iz == 20) then
!        write(*,*) "xymet",cstate%f_xmet(iz),qh2o(iz),cstate%f_rhoa_wet(iz),gc_cgs,rvap,pvap_liq
!      endif
    enddo
    end if

!    if (cstate%f_lat == -2.00 .and. cstate%f_lon == 100) then
!      write(*,*) "relhum", cstate%f_relhum
!    endif
